...
export const sha3224 = (data: Uint8Array | string) => bytesToHex(sha3_224(data));
export const sha3256 = (data: Uint8Array | string) => bytesToHex(sha3_256(data));
export const sha3384 = (data: Uint8Array | string) => bytesToHex(sha3_384(data));
export const sha3512 = (data: Uint8Array | string) => bytesToHex(sha3_512(data));
