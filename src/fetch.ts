import { default as nodeFetch, RequestInit as NodeRequestInit } from 'node-fetch-cjs';
...
export async function request(
	...
	return await nodeFetch(urlObject.toString(), options);
}

/**
 * Use delete method request.
 */
export const useDelete = async (url: string, params: Dict<any> = {}, config: NodeRequestInit = {}) => {
 ...
 */
export const useGet = async (url: string, params: Dict<any> = {}, config: NodeRequestInit = {}) => {
 ...
 */
export const usePatch = async (url: string, data: RequestData = {}, config: NodeRequestInit = {}) => {
 ...
 */
export const usePost = async (url: string, data: RequestData = {}, config: NodeRequestInit = {}) => {
 ...
 */
export const usePut = async (url: string, data: RequestData = {}, config: NodeRequestInit = {}) => {
