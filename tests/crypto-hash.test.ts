...
describe('crypto hash functions', () => {
    ...
    it('should generate correct SHA-3-224 hash', () => {
        ...
        expect(cryptoHash.cryptoSha3224ToBuffer(testData)).toEqual(
            Buffer.from('3797bf0afbbfca4a7bbba7602a2b552746876517a7f9b7ce2db0ae7b', 'hex'),
        );
    });

    it('should generate correct SHA-3-256 hash', () => {
        expect(cryptoHash.cryptoSha3256(testData)).toBe(
            '36f028580bb02cc8272a9a020f4200e346e276ae664e45ee80745574e2f5ab80',
        );

        expect(cryptoHash.cryptoSha3256ToBuffer(testData)).toEqual(
    ...
    it('should generate correct SHA-3-384 hash', () => {
        expect(cryptoHash.cryptoSha3384(testData)).toBe(
            'e516dabb23b6e30026863543282780a3ae0dccf05551cf0295178d7ff0f1b41eecb9db3ff219007c4e097260d58621bd',
        );

        expect(cryptoHash.cryptoSha3384ToBuffer(testData)).toEqual(
            Buffer.from(
                'e516dabb23b6e30026863543282780a3ae0dccf05551cf0295178d7ff0f1b41eecb9db3ff219007c4e097260d58621bd',
                'hex',
            ),
    ...
    it('should generate correct SHA-3-512 hash', () => {
        ...
        expect(cryptoHash.cryptoSha3512ToBuffer(testData)).toEqual(
            Buffer.from(
                // eslint-disable-next-line style/max-len
