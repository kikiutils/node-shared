...
describe.concurrent('cryptoMd5', () => {
    ...
    it('should generate correct string hash', ({ expect }) => {
        const result = cryptoMd5(input);
        expect(result).toBe(hashResult);
    });

    it('should generate correct buffer hash', ({ expect }) => {
        const result = cryptoMd5ToBuffer(input);
        expect(result).toEqual(Buffer.from(hashResult, 'hex'));
    });
});
...
describe.concurrent('cryptoSha3224', () => {
    ...
    it('should generate correct string hash', ({ expect }) => {
        const result = cryptoSha3224(input);
        expect(result).toBe(hashResult);
    });

    it('should generate correct buffer hash', ({ expect }) => {
        const result = cryptoSha3224ToBuffer(input);
        expect(result).toEqual(Buffer.from(hashResult, 'hex'));
    });
});
...
describe.concurrent('cryptoSha3256', () => {
    ...
    it('should generate correct string hash', ({ expect }) => {
        const result = cryptoSha3256(input);
        expect(result).toBe(hashResult);
    });

    it('should generate correct buffer hash', ({ expect }) => {
        const result = cryptoSha3256ToBuffer(input);
        expect(result).toEqual(Buffer.from(hashResult, 'hex'));
    });
});
...
describe.concurrent('cryptoSha3384', () => {
    ...
    it('should generate correct string hash', ({ expect }) => {
        const result = cryptoSha3384(input);
        expect(result).toBe(hashResult);
    });

    it('should generate correct buffer hash', ({ expect }) => {
        const result = cryptoSha3384ToBuffer(input);
        expect(result).toEqual(Buffer.from(hashResult, 'hex'));
    });
});
...
describe.concurrent('cryptoSha3512', () => {
    ...
    it('should generate correct string hash', ({ expect }) => {
        const result = cryptoSha3512(input);
        expect(result).toBe(hashResult);
    });

    it('should generate correct buffer hash', ({ expect }) => {
        const result = cryptoSha3512ToBuffer(input);
        expect(result).toEqual(Buffer.from(hashResult, 'hex'));
    });
});
