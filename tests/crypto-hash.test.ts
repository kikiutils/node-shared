...
describe('cryptoSha3512', () => {
    ...
    it('should generate correct string hash', () => expect(cryptoSha3512(testData)).toBe(hashResult));
    it('should generate correct buffer hash', () => {
